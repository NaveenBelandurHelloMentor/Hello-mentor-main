        ...
        <>
            <section className={Style.mainContainer} >
                <div className={Style.firstSection}>
                    <h2 className={`title-primary`}>Success Coach</h2>
                ...
                <div className={Style.firstcard}>
                    <div className={Style.firstcardbox}>
                        ...
                        <div className={Style.firstcardclm}>
                            <div >
                                <h2 className={`title-md-primary`}>Ms. Sangeetha</h2>
                                <p className={`body-md-secondary ${Style.crd}`}>128 sessions taken</p>
                            </div>
                            <div>
                                <h2 className={`title-sm-primary ${Style.cd_}`}>Connect with Your Psychology Mentor Today :)</h2>
                                <p className={`body-md-tertiary ${Style.cont}`}>Master Your Mind for NEET Success: Enhance Confidence, Conquer Stress, and Excel in Your Exams</p>
                            </div>
                            <div>
                        ...
                        <div className={Style.firstCardcore}>
                            ...
                            <div className={intstate == false ? Style.coreattributes : Style.coretnt}>
                                    <div className={Style.core} id={Style.firstText}><ArrowSvg/><p className={Style.corefnt} >Cost friendly</p></div>
