    ...
    <>
      <section className={Style.mainContainer}>
        <div className={Style.container}>
          ...
          {toogle == false ? <><div className={Style.secondcontainer}>
            ...
            <div className={Style.card}>
              ...
              <div className={Style.cardBottom}>
                <div className={Style.cardBottomcontainer} >
                 ...
                 <p className={`body-sm-tertiary`}>Live<GreenSvg/></p>
                 </div>
                </div>
            ...
            <div>
              <button className={Style.viewBtn} onClick={HandleViewMore} ><ArrowSvg /></button>
              <p className={`body-sm-secondary ${Style.cardfnt}`}   onClick={HandleViewMore}  >view More</p>
            </div>
          </div>
        ...
        {model && <ModelContainer open={setModel}/>}
      </section>
    </>
  )
}
